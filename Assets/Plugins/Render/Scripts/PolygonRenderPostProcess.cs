...
namespace PolygonRender
{
    ...
    public class PolygonRenderPostProcess : MonoBehaviour
    {
        ...
        public PolygonRenderSettings settings;
        ...
        private void CreateDefaultSettingsIfNoneLinked()
        {
            if (settings == null)
            {
                settings = ScriptableObject.CreateInstance<PolygonRenderSettings>();
