...
namespace PolygonRender
{
    public class DualFilterBloomRenderer
    {
        ...
        public RenderTexture ApplyToAndReturn(RenderTexture source, PolygonRenderSettings settings)
        {
        ...
        public void CreateResources(PolygonRenderSettings settings, Camera camera)
        {
        ...
        private void CalculateBloomHeightAndWidth(PolygonRenderSettings settings, Camera camera)
        {
        ...
        public bool SomeSettingsHaveChanged(PolygonRenderSettings settings)
        {
